...
- ⚡ **Powered by Vite** – Fast and optimized for performance.  
...
You can easily customize the names used in the application by editing the **`src/config.ts`** file:

```typescript
export const CONFIG = {
  yourName: "Your Name",      // Your name (the sender)
  recipientName: "My Dearest", // How you address your partner
};
```
